...
Future<void> downloadFiles(String directory, {String media = 'video'}) async {
  // curl -X 'GET' \
...
String getImageDownloadUri(String fileName) {
  var imageFile = data.imageFileByName[fileName];
  var imageFilePath = imageFile!.imageFilePath;
  var settings = data.serverSettings();
  var queryParameters = {'file_path': imageFilePath};
...
String getVideoDownloadUri(String fileName) {
